angular.module('marathon').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('directives/selectedRunnerInfo.html',
    ...
    "            <div class=\"selected-runner-info__result-time\">{{selectedRunnerOnGraph.result_time_string}}</div>\n" +
    "            <div class=\"selected-runner-info__result-position\">\n" +
    "               <!-- в локализацию -->\n" +
    "                {{selectedRunnerOnGraph|finishedPosition}}</div>\n" +
    "        </div>\n" +
  ...
  $templateCache.put('directives/timeMarks.html',
    "<div class=\"time-marks\">\n" +
    "    <div class=\"time-mark\"\n" +
    "         data-ng-repeat=\"mark in timeMarks\"\n" +
    "         style=\"left: {{timeScale(mark)}}px;\">\n" +
    "        <span class=\"time-mark__from-start\">{{mark | formatTimeFromStart:time.start}}</span> <br>\n" +
    "        <span class=\"time-mark__from-day\">{{mark | formatTimeFromDay}}</span>\n" +
    "    </div>\n" +
    "</div>\n"
  );
